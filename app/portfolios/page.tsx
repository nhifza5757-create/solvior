            ...
            {projects.map((p) => (
              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 p-6">
                  <h3 className="font-display text-lg font-semibold text-white transition-all duration-300 group-hover:tracking-wide group-active:tracking-wide group-hover:translate-x-1 group-active:translate-x-1">
                    {p.title}
                  </h3>
                  <div className="mt-3 flex gap-2">
                    {p.tags?.map((tag) => (
                      <span
                        key={tag}
                        className="rounded-full bg-white/15 px-3 py-1 text-xs text-white backdrop-blur transition-colors duration-300 hover:bg-[#0075ff] active:bg-[#0075ff]"
                      >
                        {tag}
                      </span>
                    ))}
