          ...
          <div className="mt-14 grid grid-cols-1 divide-y divide-border border border-border sm:grid-cols-2 sm:divide-x sm:divide-y-0 lg:grid-cols-4">
            {contactCards.map((card, i) => (
              <Reveal
                ...
                animation="fadeInUp"
                delay={i * 0.15}
                className="group relative px-8 py-12 text-center transition-shadow duration-300 hover:z-10 hover:shadow-xl"
              >
                <div className="relative mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-accent/10 transition-all duration-300 group-hover:scale-110 group-hover:bg-accent">
                  <card.icon className="h-8 w-8 text-accent transition-colors duration-300 group-hover:text-white" />
                  {card.accent && (
                    <span className="absolute -right-1 -top-1 flex h-6 w-6 items-center justify-center rounded-full border-2 border-white bg-transparent">
                      <span className="h-1.5 w-1.5 rounded-full bg-accent transition-colors duration-300 group-hover:bg-white" />
                    </span>
                  )}
                </div>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 border border-border lg:grid-cols-2">
            ...
            <Reveal animation="fadeInLeft" className="p-8 sm:p-10 lg:p-14">
              ...
              <form className="mt-10 space-y-8">
                <div className="grid grid-cols-1 gap-x-8 gap-y-8 sm:grid-cols-2">
                  <div className="group relative border-b border-border pb-3 transition-colors duration-300 hover:border-primary-dark focus-within:border-accent">
                  ...
                  <div className="group relative border-b border-border pb-3 transition-colors duration-300 focus-within:border-accent">
                    ...
                    <div className="relative mt-2">
                      <select className="w-full cursor-pointer appearance-none bg-transparent text-sm text-primary focus:outline-none">
                ...
                <button
                  type="submit"
                  data-cursor-hover
                  className="group relative inline-flex items-center overflow-hidden rounded-full bg-primary-dark py-2 pl-3 pr-7 text-sm font-semibold text-white transition-transform duration-300 hover:-translate-y-0.5 hover:shadow-lg"
                >
                  <span
                    aria-hidden
            ...
            <Reveal animation="fadeInRight" className="relative min-h-[420px] lg:min-h-full">
              ...
              />
              <div className="absolute left-4 top-4 flex items-center gap-3 rounded-xl bg-white px-4 py-3 shadow-lg transition-shadow duration-300 hover:shadow-2xl">
                <div>
                ...
                <a
                  ...
                  className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-border text-primary transition-all duration-300 hover:border-accent hover:bg-accent hover:text-white"
                >
