    ...
    <div className="flex items-center gap-3">
      ...
      {[
        ...
        <button
          ...
          data-cursor-hover
          onClick={() => share(key)}
          className="flex h-8 w-8 items-center justify-center rounded-full bg-muted text-primary transition hover:bg-accent active:bg-accent hover:text-white active:text-white"
        >
            ...
            <div className="rounded-none border border-border p-6">
              <div className="flex items-start justify-between gap-4">
                ...
                <button
                  ...
                  className="flex shrink-0 items-center gap-1.5 text-xs font-semibold text-primary hover:text-accent active:text-accent"
                >
              ...
              {replyingTo === comment.id && (
                <div className="mt-4 flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="shrink-0 rounded-full bg-primary px-4 py-2 text-xs font-semibold text-white hover:bg-accent active:bg-accent"
                  >
                    Post
                  </button>
                </div>
