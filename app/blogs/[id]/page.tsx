  ...
  <div className="relative z-10 flex w-full items-center justify-center px-5 sm:px-6">
    <div className="max-w-4xl text-center text-white">
      ...
      <Reveal animation="fadeInUp" delay={0.15}>
        <div className="mt-6 inline-flex max-w-full flex-wrap items-center justify-center gap-2 rounded-full border border-white/30 bg-white/10 px-5 py-2 text-xs backdrop-blur-md sm:text-sm">
          ...
          <span className="max-w-[140px] truncate text-white/80 sm:max-w-none">
            {post.title}
          </span>
