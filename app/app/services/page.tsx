      ...
      <section className="py-20 lg:py-28">
        <div className="container-custom">
              ...
              <Reveal key={service.id} animation="fadeInUp" delay={i * 0.08}>
                ...
                >
                  ...
                  <div className="relative z-10 flex h-full flex-col">
                    <span className="mb-6 flex h-16 w-16 shrink-0 items-center justify-center rounded-full bg-surface-soft text-accent transition-colors duration-500 group-hover:bg-white">
                      {ICONS[service.id] ?? ICONS[1]}
                    </span>

                    <span className="mb-3 block text-sm font-semibold text-muted-foreground transition-colors duration-300 group-hover:text-white/70">
                      {String(service.id).padStart(2, "0")}
                    </span>

                    <h3 className="mb-4 font-display text-2xl font-bold text-primary transition-colors duration-300 group-hover:text-white">
                      {service.title}
                    </h3>

                    <p className="mb-8 flex-1 text-sm leading-relaxed text-muted-foreground transition-colors duration-300 group-hover:text-white/80">
                      {service.description}
                    </p>

                    <span className="mt-auto inline-flex items-center text-sm font-bold text-primary transition-colors duration-300 group-hover:text-white">
                      Get optimization
          ...
          <Reveal animation="fadeInUp" className="mt-16 flex items-center justify-center gap-3">
            ...
            <span
              data-cursor-hover
              className="flex h-10 w-10 cursor-pointer items-center justify-center rounded-full text-sm font-medium text-muted-foreground transition-colors duration-300 hover:bg-muted"
            >
              02
            </span>
            <span
              ...
              className="flex h-10 w-10 cursor-pointer items-center justify-center rounded-full text-muted-foreground transition-colors duration-300 hover:bg-muted"
            >
