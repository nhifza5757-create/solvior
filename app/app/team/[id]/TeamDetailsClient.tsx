          ...
          <div className="lg:col-span-7 flex flex-col">
            <Reveal animation="fadeInUp">
              ...
              <div className="flex gap-3 mb-10">
                <a href={siteConfig.socials.facebook} target="_blank" rel="noopener noreferrer" data-cursor-hover className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-100 text-[#0a1426] transition-colors hover:bg-[#0075ff] hover:text-white">
                  <Facebook className="h-4 w-4" />
                </a>
                <a href={siteConfig.socials.twitter} target="_blank" rel="noopener noreferrer" data-cursor-hover className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-100 text-[#0a1426] transition-colors hover:bg-[#0075ff] hover:text-white">
                  <Twitter className="h-4 w-4" />
                </a>
                <a href={siteConfig.socials.instagram} target="_blank" rel="noopener noreferrer" data-cursor-hover className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-100 text-[#0a1426] transition-colors hover:bg-[#0075ff] hover:text-white">
                  <Instagram className="h-4 w-4" />
                </a>
                <a href={siteConfig.socials.linkedin} target="_blank" rel="noopener noreferrer" data-cursor-hover className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-100 text-[#0a1426] transition-colors hover:bg-[#0075ff] hover:text-white">
              ...
              <Reveal animation="fadeInUp" delay={0.1}>
                <form onSubmit={handleTeamFormSubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div className="sm:col-span-2 flex items-center gap-4">
                    <button type="submit" data-cursor-hover className="group relative inline-flex w-fit items-center overflow-hidden rounded-full bg-[#0a1426] py-2 pl-3 pr-7 text-sm font-semibold text-white transition-transform duration-300 hover:-translate-y-0.5 hover:shadow-xl">
                      <span
                        aria-hidden
