...
export default function TeamPage() {
  return (
    <div>
      ...
      <section className="relative -mt-[104px] flex h-[360px] items-center justify-center overflow-hidden pt-[104px] sm:h-[450px]">
        <Image
          src={HERO_BG}
          alt="Team background"
          fill
      ...
      <section className="py-20 lg:py-28 bg-white">
        <div className="container mx-auto max-w-7xl px-4">
              ...
              <Reveal key={member.id} animation="fadeInUp" delay={index * 0.1}>
                <div className="group relative overflow-hidden bg-white transition-all duration-300">
                  <div className="relative aspect-[3/4] overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-[#0a1426] via-[#0a1426]/40 to-transparent opacity-60 transition-opacity duration-500 group-hover:opacity-90" />
                  </div>
                  
                  {/* Name & Role - Slides up slightly on hover */}
                  <div className="absolute bottom-0 left-0 w-full p-6 text-white text-center transition-all duration-500 group-hover:-translate-y-1">
          ...
          <div className="mt-14 flex items-center justify-center gap-3">
            <span className="flex h-10 w-10 items-center justify-center rounded-full bg-[#0075ff] text-sm font-semibold text-white cursor-pointer transition-colors hover:bg-blue-700">
              01
            </span>
            <span className="flex h-10 w-10 items-center justify-center rounded-full border border-gray-200 text-sm font-semibold text-[#0a1426] cursor-pointer transition-colors hover:bg-gray-50">
              02
            </span>
            <span className="flex h-10 w-10 items-center justify-center rounded-full border border-gray-200 text-[#0a1426] cursor-pointer transition-colors hover:bg-gray-50">
