          ...
          <Reveal animation="fadeInUp" delay={0.1} className="relative lg:w-[40%] h-[400px] lg:h-auto overflow-hidden group">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white p-6">
              <button
                ...
                className="w-16 h-16 bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center mb-4 hover:scale-110 transition-transform duration-300"
              >
              ...
              <div className="flex items-center justify-between pt-6 border-t border-gray-200">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="w-10 h-10 rounded-full border border-gray-300 flex items-center justify-center text-gray-500 hover:bg-[#0075ff] hover:text-white hover:border-[#0075ff] transition-colors duration-300"
                  >
