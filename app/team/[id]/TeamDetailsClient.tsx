    ...
    <div>
          ...
          <div className="lg:col-span-7 flex flex-col">
            <Reveal animation="fadeInUp">
              ...
              <div className="flex gap-3 mb-10">
                <a href="#" className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-100 text-[#0a1426] transition-colors hover:bg-[#0075ff] hover:text-white">
      ...
      <section className="py-20 lg:py-28 bg-[#F0F5FF]">
        <div className="container mx-auto max-w-7xl px-4">
          <div className="bg-white shadow-sm rounded-2xl p-8 lg:p-12 grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-7">
              <Reveal animation="fadeInUp" delay={0.1}>
                <form className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    <input type="text" placeholder="Full name*" className="w-full bg-[#F8F9FA] border border-gray-200 rounded px-4 py-3 text-sm focus:outline-none focus:border-[#0075ff] transition-colors" />
                  </div>
                  <div>
                    <input type="email" placeholder="Email address*" className="w-full bg-[#F8F9FA] border border-gray-200 rounded px-4 py-3 text-sm focus:outline-none focus:border-[#0075ff] transition-colors" />
                  </div>
                  <div>
                    <input type="tel" placeholder="Phone number*" className="w-full bg-[#F8F9FA] border border-gray-200 rounded px-4 py-3 text-sm focus:outline-none focus:border-[#0075ff] transition-colors" />
                  </div>
                  <div>
                    <select className="w-full bg-[#F8F9FA] border border-gray-200 rounded px-4 py-3 text-sm text-gray-500 focus:outline-none focus:border-[#0075ff] transition-colors">
                  ...
                  <div className="sm:col-span-2">
                    <textarea placeholder="Type message" rows={4} className="w-full bg-[#F8F9FA] border border-gray-200 rounded px-4 py-3 text-sm focus:outline-none focus:border-[#0075ff] transition-colors resize-none"></textarea>
                  </div>
                  <div className="sm:col-span-2">
