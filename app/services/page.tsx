...
const FALLBACK_IMAGE = "/images/project/h2-project-1.webp";
...
const ICONS: React.ReactNode[] = [
  (
    <svg key="i1" width="24" height="24" viewBox="0 0 24 24" fill="none">
      <path d="M12 3a9 9 0 1 0 9 9c0-1.5-.4-2.9-1.1-4.1M12 3v4m0-4c2 0 3.8.8 5.1 2" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
    </svg>
  ),
  (
    <svg key="i2" width="24" height="24" viewBox="0 0 24 24" fill="none">
  ...
  (
    <svg key="i3" width="24" height="24" viewBox="0 0 24 24" fill="none">
  ...
  (
    <svg key="i4" width="24" height="24" viewBox="0 0 24 24" fill="none">
      <path d="M4 21V9l8-5 8 5v12M4 21h16M9 21v-6h6v6" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  ),
  (
    <svg key="i5" width="24" height="24" viewBox="0 0 24 24" fill="none">
      <circle cx="12" cy="12" r="9" stroke="currentColor" strokeWidth="1.6" />
      <path d="M12 3a9 9 0 0 1 9 9h-9V3Z" fill="currentColor" />
    </svg>
  ),
  (
    <svg key="i6" width="24" height="24" viewBox="0 0 24 24" fill="none">
      <path d="M4 12h13M11 6l6 6-6 6" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M4 6l3 3-3 3" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" opacity="0.5" />
    </svg>
  ),
];
...
async function getServices(): Promise<Service[]> {
  try {
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/services`, {
      cache: "no-store", // always fetch fresh data — never serve a stale/static copy
    });
    if (!res.ok) return [];
    return res.json();
  } catch {
  ...
  return (
    <div>
      ...
      <section className="relative -mt-[104px] flex min-h-[500px] items-center justify-center overflow-hidden pt-[104px] sm:h-[550px]">
        <Image src={HERO_BG} alt="Services Background" fill priority className="animate-hero-zoom object-cover object-center" />
        ...
        <div className="relative z-10 flex w-full items-center justify-center px-5 sm:px-6">
          <div className="max-w-4xl text-center text-white">
            <Reveal animation="fadeInUp">
              <h1 className="font-display text-[34px] font-bold leading-tight sm:text-5xl lg:text-6xl">Services</h1>
            </Reveal>
      ...
      <section className="relative overflow-hidden bg-accent py-16">
        <span aria-hidden className="shape-zoominout absolute -left-10 top-1/2 h-40 w-40 -translate-y-1/2 rounded-full border border-white/20" />
        <span aria-hidden className="shape-move absolute -right-10 top-1/2 h-56 w-56 -translate-y-1/2 rounded-full border border-white/20" />
