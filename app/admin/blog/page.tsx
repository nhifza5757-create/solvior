      ...
      {!loading && !error && posts.length > 0 && (
        <>
          ...
          <div className="space-y-3 md:hidden">
            {posts.map((p) => (
              <div key={p.id} onClick={() => router.push(`/admin/blog/${p.id}`)} className="cursor-pointer rounded-xl border border-gray-100 bg-white p-4 shadow-sm transition-all hover:border-[#0075ff]/30 hover:shadow-md hover:-translate-y-0.5">
          ...
          <div className="hidden md:block space-y-3">
            {posts.map((p) => (
              <div key={p.id} onClick={() => router.push(`/admin/blog/${p.id}`)} className="flex cursor-pointer items-center gap-6 rounded-xl border border-gray-100 bg-white px-5 py-4 shadow-sm transition-all hover:border-[#0075ff]/30 hover:shadow-md hover:-translate-y-0.5">
